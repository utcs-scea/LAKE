                                         ...
                                         size_t *func_arg_size)
{
    ...
    *func_argc = 0;
    assert(strncmp(name, "_Z", 2) == 0 && "Wrong CUDA function name");
        ...
        switch(name[i]) {
            case 'P':
                ...
                if (i + 1 < strlen(name) &&
                    ...
                    assert(0 && "CUDA function argument: wrong pointer");
                }
                break;
            ...
            default:
                assert(0 && "CUDA function argument: unrecognized type");
        }
        i++;
    }
...
static inline void print_timestamp(const char *name) {
    struct timeval tv;
