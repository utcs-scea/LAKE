/** NightWatch MODIFIED header for Intel(R) Movidius(TM) Neural Compute SDK (version 2.08.01)
 *  Lines marked with "NWR:" were removed by NightWatch.
 *  All lines are from the original headers: mvnc.h
 */
/*
*
...
/* NWR: dllexport ncStatus_t ncGlobalGetOption(int option, void *data, */
/* NWR:                         unsigned int *dataLength); */

// Device
/* NWR: dllexport ncStatus_t ncDeviceSetOption(struct ncDeviceHandle_t *deviceHandle, */
/* NWR:                         int option, const void *data, */
/* NWR:                         unsigned int dataLength); */
/* NWR: dllexport ncStatus_t ncDeviceGetOption(struct ncDeviceHandle_t *deviceHandle, */
/* NWR:                         int option, void *data, unsigned int *dataLength); */
...
/* NWR: dllexport ncStatus_t ncGraphAllocate(struct ncDeviceHandle_t *deviceHandle, */
/* NWR:                         struct ncGraphHandle_t *graphHandle, */
/* NWR:                         const void *graphBuffer, unsigned int graphBufferLength); */
dllexport ncStatus_t ncGraphDestroy(struct ncGraphHandle_t **graphHandle);
/* NWR: dllexport ncStatus_t ncGraphSetOption(struct ncGraphHandle_t *graphHandle, */
/* NWR:                         int option, const void *data, unsigned int dataLength); */
/* NWR: dllexport ncStatus_t ncGraphGetOption(struct ncGraphHandle_t *graphHandle, */
/* NWR:                         int option, void *data, */
/* NWR:                         unsigned int *dataLength); */
...
// Fifo
/* NWR: dllexport ncStatus_t ncFifoCreate(const char* name, ncFifoType_t type, */
/* NWR:                         struct ncFifoHandle_t** fifoHandle); */
/* NWR: dllexport ncStatus_t ncFifoAllocate(struct ncFifoHandle_t* fifoHandle, */
/* NWR:                         struct ncDeviceHandle_t* device, */
/* NWR:                         struct ncTensorDescriptor_t* tensorDesc, */
/* NWR:                         unsigned int numElem); */
/* NWR: dllexport ncStatus_t ncFifoSetOption(struct ncFifoHandle_t* fifoHandle, int option, */
/* NWR:                         const void *data, unsigned int dataLength); */
