...
python3 mlHeaderGen.py Trace nvme0n1 mlData/drive0weights "weights_header+1"
python3 mlHeaderGen.py Trace nvme1n1 mlData/drive1weights "weights_header+1"
python3 mlHeaderGen.py Trace nvme2n1 mlData/drive2weights "weights_header+1"