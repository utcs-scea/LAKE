...
sudo ./replayer baseline /dev/nvme0n1-/dev/nvme1n1-/dev/nvme2n1 ./testTraces/100lines.trace ./testTraces/100lines.trace ./testTraces/100lines.trace outputs/test10output
